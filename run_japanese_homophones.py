...
def save_pipeline_stats(result_dir, corrector):
    ...
    stats = {
        ...
        "llm_recheck_calls": int(getattr(corrector, "llm_recheck_calls", 0)),
        "llm_recheck_keep": int(getattr(corrector, "llm_recheck_keep", 0)),
        "llm_recheck_changed": int(getattr(corrector, "llm_recheck_changed", 0)),
        ...
        "seed_map_applied": int(getattr(corrector, "seed_map_applied", 0)),
